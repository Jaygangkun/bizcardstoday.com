...
// 	{
// 		$_POST['Line_' . $j] = 
// 			ereg_replace('&(amp;| *)reg;', '®', str_replace('*', '·', htmlentities(stripslashes( str_replace("&quot;", "\"", $_POST['Line_' . $j])))));
// 		$j++;
// 	}
...
//echo("</pre>");
		...
		if($sql->data[1]=='y')
		{
			...
			$msg .="<br>\n<br>\nThis order is pending approval.  It can be reviewed by clicking the link below:\n<br>
				<a href=\"http://www.bizcardstoday.com/approval.php?asdfo845asdf34=asdf3ee4r_q34w5jladf&target=" . 
				$card['ID'] . "&234rrasd9f83t__233=zzsdfwcvoi23450adslfjaowerjoiasdf2348afjow_238\">Review and Approve this Order</a><br>\n";
...
// replaced the fopen with a file_exists in the new version
	if(@fopen("http://www.bizcardstoday.com/images/finished/" . $template . ".svg", 'r'))
	{

...
if(!isset($_SESSION['reorderState'])) $_SESSION['reorderState'] = 0;
...
// if image flag set, set two queries for the last selected card instead of the card selected by 
...
<head>
	...
	<!--
	<?  //This only pops if a Duplicate Card is found.
		if($alerter!="")
		{
		echo $alerter;
		$alerter="";
...
<body bgcolor=#ffffff leftmargin=5px>
	...
	<tr>
		<td>
			...
			<? echo $dimension; ?> type="image/svg+xml" 
		...
		<td>Welcome <? echo $sql->data['Name']; ?><br><br>This is the design approved for your 
